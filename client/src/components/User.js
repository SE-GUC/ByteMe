...
class User extends Component {
    ...
    render() {
        ...
        const { email, first_name, last_name, birth_date, guc_id, mun_role, picture_ref } = this.state.user
                ...
                <Row>
                    <Media>
                        <img
                            ...
                            height={128}
                            className="mr-3"
                            src={picture_ref ? picture_ref : "https://www.watsonmartin.com/wp-content/uploads/2016/03/default-profile-picture.jpg"}
                            alt="Generic placeholder"
                        />
                        <Media.Body>
                            <h5>{(first_name + " " + last_name)
                                .split(' ').map(i => i[0].toUpperCase() + i.substring(1).toLowerCase()).join(' ')}</h5>
                        </Media.Body>
                    </Media>
                </Row>
                <Row>
